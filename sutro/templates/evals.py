...
class EvalTemplates(BaseSutroClient):
    def score(self, *args, **kwargs):
        return self.Score.score(self, *args, **kwargs)

    @property
    def rank(self):
        if not hasattr(self, "_rank_accessor"):
            outer_self = self

            class _RankAccessor:
                def __call__(self, *args, **kwargs):
                    return outer_self.Rank.rank(outer_self, *args, **kwargs)

                def elo(self, *args, **kwargs):
                    return outer_self.Rank.elo(outer_self, *args, **kwargs)

            self._rank_accessor = _RankAccessor()
        return self._rank_accessor
